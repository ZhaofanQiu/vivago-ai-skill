...
try:
    ...
    print('\n' + '='*60)
    print('✅ 模板 gta_star 测试成功!')
    print('='*60)
    
    cache.save_test_result('template_gta_star', {'status': 'success'})
    
except Exception as e:
    print('\n' + '='*60)
    print('❌ 模板 gta_star 测试失败')
    print('='*60)
    print(f'错误: {e}')
    cache.record_failure('templates', 'gta_star', str(e))
