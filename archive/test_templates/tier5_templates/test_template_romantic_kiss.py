...
print('='*60)
print('Tier 5: 模板测试')
print('模板: romantic_kiss')
print('名称: Romantic Kiss')
print('积分: 30')
print('='*60)
...
try:
    result = client.template_to_video(
        ...
        template='romantic_kiss',
        wh_ratio='1:1'
    )
    
    print('\n' + '='*60)
    print('✅ 模板 romantic_kiss 测试成功!')
    print('='*60)
    
    cache.save_test_result('template_romantic_kiss', {'status': 'success'})
    
except Exception as e:
    print('\n' + '='*60)
    print('❌ 模板 romantic_kiss 测试失败')
    print('='*60)
    print(f'错误: {e}')
    cache.record_failure('templates', 'romantic_kiss', str(e))
