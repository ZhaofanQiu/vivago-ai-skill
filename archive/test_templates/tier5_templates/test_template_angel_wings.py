...
print('='*60)
print('Tier 5: 模板测试')
print('模板: angel_wings')
print('名称: Angel Wings')
print('积分: 30')
print('='*60)
...
try:
    ...
    print('\n' + '='*60)
    print('✅ 模板 angel_wings 测试成功!')
    print('='*60)
    
    cache.save_test_result('template_angel_wings', {'status': 'success'})
    
except Exception as e:
    print('\n' + '='*60)
    print('❌ 模板 angel_wings 测试失败')
    print('='*60)
    print(f'错误: {e}')
    cache.record_failure('templates', 'angel_wings', str(e))
