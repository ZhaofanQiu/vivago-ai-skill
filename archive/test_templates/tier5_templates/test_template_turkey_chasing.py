...
print('='*60)
print('Tier 5: 模板测试')
print('模板: turkey_chasing')
print('名称: Turkey Chasing')
print('积分: 30')
print('='*60)
...
try:
    result = client.template_to_video(
        ...
        template='turkey_chasing',
        wh_ratio='1:1'
    )
    
    print('\n' + '='*60)
    print('✅ 模板 turkey_chasing 测试成功!')
    print('='*60)
    
    cache.save_test_result('template_turkey_chasing', {'status': 'success'})
    
except Exception as e:
    print('\n' + '='*60)
    print('❌ 模板 turkey_chasing 测试失败')
    print('='*60)
    print(f'错误: {e}')
    cache.record_failure('templates', 'turkey_chasing', str(e))
