...
print('='*60)
print('视频测试: 视频首尾帧 (Keyframe-to-Video)')
print('端口: v3L (360p)')
print('积分: 20')
print('='*60)
...
try:
    result = client.keyframe_to_video(
        prompt='smooth transition effect between frames',
    ...
    cache.save_test_result('video_keyframe', {'status': 'success'})
    ...
    print('='*60)
    print(f'错误: {e}')
    cache.record_failure('video_tests', 'keyframe', str(e))
